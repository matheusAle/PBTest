...
public final class Arquivos {
    ...
    public static Image ICONE_APP;

    static {
        ClassLoader cl = Arquivos.class.getClassLoader();
        IMG_PERFIL_PADRAO = new ImageIcon(cl.getResource("/resources/icones/imgPerfilGenerico.jpg"));
        ICONE_APP = Toolkit.getDefaultToolkit().getImage(cl.getResource("/resources/icones/app.png"));
        try {
